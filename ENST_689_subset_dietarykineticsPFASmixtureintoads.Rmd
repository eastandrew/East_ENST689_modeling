...
install_load("knitr", "readxl","tidyverse","deSolve","minpack.lm","FME","ggpubr", "nlstools", "investr","propagate",  "mgcv", "mosaicCalc")
...
parmeters <- c(k12 = 0.146,
               ...
               kel = 0.007)#,
               #kel2 = 0.1) 
times <- seq(0, 56, by=0.1) # start points to end points
