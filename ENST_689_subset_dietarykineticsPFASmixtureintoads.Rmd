...
nlspl <- nls(conc3~259.767+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*day)-exp(-k01*day)), 
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nls(ys~259.767+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*xs)-exp(-k01*xs)), 
           start=list(V=0.1, k01=0.146))
  cvs[j] <- (y[j]-predict(d,data.frame(xs=x[j])))^2
  print(paste0(j," of ",n," finished (",round(j/n*100),"%)"))
}

plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nls(y~259.767+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*x)-exp(-k01*x)), 
           start=list(V=0.1, k01=0.146))
...
nls8l <- nls(conc3~0.1+((885.228*k01)/(V*(k01-0.108)))*(exp(-0.108*day)-exp(-k01*day)), 
               data=toad%>%filter(PFAS=="8:2 FTS"&tissue=="Liver"&day%in%c(0:56)), 
               start=list(V=0.1, k01=0.938) #,trace=T
             )
summary(nls8l)
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nls(ys~0.1+((885.228*k01)/(V*(k01-0.108)))*(exp(-0.108*xs)-exp(-k01*xs)), 
...
plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nls(y~0.1+((885.228*k01)/(V*(k01-0.108)))*(exp(-0.108*x)-exp(-k01*x)), 
...
nlspw <- nls(conc3~26.568+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*day)-exp(-k01*day)), 
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nls(ys~26.568+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*xs)-exp(-k01*xs)), 
...
plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nls(y~26.568+((697.138*k01)/(V*(k01-0.007)))*(exp(-0.007*x)-exp(-k01*x)), 
           start=list(V=0.1, k01=0.265))
lines(predict(d)[order(x)]~sort(x), lwd=4, col='black')
usr <- par("usr")
text(usr[1] + 0.9*(usr[2]-usr[1]), usr[3] + 0.9*(usr[4]-usr[3]), paste("LOO MSE", "=", round(mean(cvs), 5)), pos=2)
...
nls8l <- nls(conc3~0.1+((885.228*k01)/(V*(k01-0.091)))*(exp(-0.091*day)-exp(-k01*day)), 
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nls(ys~0.1+((885.228*k01)/(V*(k01-0.091)))*(exp(-0.091*xs)-exp(-k01*xs)), 
...
plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nls(y~0.1+((885.228*k01)/(V*(k01-0.091)))*(exp(-0.091*x)-exp(-k01*x)), 
           start=list(V=0.1, k01=0.828))
lines(predict(d)[order(x)]~sort(x), lwd=4, col='black')
usr <- par("usr")
text(usr[1] + 0.9*(usr[2]-usr[1]), usr[3] + 0.9*(usr[4]-usr[3]), paste("LOO MSE", "=", round(mean(cvs), 5)), pos=2)
...
nlspl2 <- nlsLM(conc3~259.767+((697.138*k01)/(V*(k01-k10)))*(exp(-k10*day)-exp(-k01*day)), 
               data=toad%>%filter(PFAS=="PFOS"&tissue=="Liver"&day%in%c(0:56)), 
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nlsLM(ys~259.767+((697.138*k01)/(V*(k01-k10)))*(exp(-k10*xs)-exp(-k01*xs)), 
...
plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nlsLM(y~259.767+((697.138*k01)/(V*(k01-k10)))*(exp(-k10*x)-exp(-k01*x)), 
           start=list(V=0.5, k01=0.057, k10=0.007))
lines(predict(d)[order(x)]~sort(x), lwd=4, col='black')
usr <- par("usr")
text(usr[1] + 0.9*(usr[2]-usr[1]), usr[3] + 0.9*(usr[4]-usr[3]), paste("LOO MSE", "=", round(mean(cvs), 5)), pos=2)
...
nls8l2 <- nlsLM(conc3~0.1+((885.228*k01)/(V*(k01-k10)))*(exp(-k10*day)-exp(-k01*day)), 
               data=toad%>%filter(PFAS=="8:2 FTS"&tissue=="Liver"&day%in%c(0:56)), 
...
for(j in seq(n)){
  ys <- y[-j]
  xs <- x[-j]
  d <- nlsLM(ys~0.1+((885.228*k01)/(V*(k01-k10)))*(exp(-k10*xs)-exp(-k01*xs)), 
...
plot(y~x, pch=19, col='gray', cex=1.5, xlab='day', ylab='conc')
d <- nlsLM(y~0.1+((885.228*k01)/(V*(k01-k10)))*(exp(-k10*x)-exp(-k01*x)), 
           start=list(V=2, k01=0.05, k10=0.108))
lines(predict(d)[order(x)]~sort(x), lwd=4, col='black')
usr <- par("usr")
text(usr[1] + 0.9*(usr[2]-usr[1]), usr[3] + 0.9*(usr[4]-usr[3]), paste("LOO MSE", "=", round(mean(cvs), 5)), pos=2)
...
dose_data <- data.frame(
  ...
  value=c(as.numeric(697.138*0.25),as.numeric(697.138*0.001)),
  method="add"
)
